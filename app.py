...
COUNTRIES = sorted([
    ...
    "Congo, Dem. Rep.", "Guinea", "Gabon", "Namibia", "Botswana",
    "Mauritius", "Cabo Verde", "Eswatini", "Lesotho", "Sierra Leone",
    "Liberia", "Guinea-Bissau", "Gambia", "Mauritania"
])
...
COUNTRY_INCLUSION_RATE = {
    "Angola": 0.43, "Benin": 0.38, "Botswana": 0.75, "Burkina Faso": 0.43,
    "Cabo Verde": 0.66, "Cameroon": 0.36, "Chad": 0.22,
    "Congo, Dem. Rep.": 0.26, "Congo, Rep.": 0.26, "Côte d'Ivoire": 0.41,
    "Eswatini": 0.45, "Ethiopia": 0.46, "Gabon": 0.59, "Gambia": 0.38,
    "Ghana": 0.57, "Guinea": 0.23, "Guinea-Bissau": 0.29,
    "Kenya": 0.79, "Lesotho": 0.51, "Liberia": 0.36,
    "Madagascar": 0.18, "Malawi": 0.36, "Mali": 0.35, "Mauritania": 0.33,
    "Mauritius": 0.91, "Mozambique": 0.34, "Namibia": 0.78, "Niger": 0.22,
    "Nigeria": 0.45, "Rwanda": 0.93, "Senegal": 0.56, "Sierra Leone": 0.23,
    "South Africa": 0.85, "Tanzania": 0.52, "Togo": 0.42, "Uganda": 0.48,
    "Zambia": 0.45, "Zimbabwe": 0.53,
}
...
def build_model():
    ...
    country_enc = country_le.transform(countries)
...
with st.expander("📊 Why this matters"):
    ...
    col3.metric("Lowest (Madagascar)", "18%", help="Findex 2021")
    st.caption("Account ownership at a financial institution or mobile money provider across 38 Sub-Saharan African countries. Source: World Bank Global Findex 2021.")
